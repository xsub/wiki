...
```
Please check if you have FIPS mode enabled which prevents 'unauthorized' uses of OpenSSL framework.
```
...
(Like: https://almalinux.example.com). The connection is encrypted 🔒 
